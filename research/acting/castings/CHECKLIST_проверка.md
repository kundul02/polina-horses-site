...
5. Синхронизируй programs.html (категория «Кастинги в актёрском мастерстве»):
   - новые → карточка с summary + desc
   - истёкшие → closed: true, deadline «Закрыт (дата)»
6. В desc каждой карточки ОБЯЗАТЕЛЬНО: «Актёрство: lead | featured | ensemble | talent_search · Оплата: да/нет»
7. cp programs.html index.html
